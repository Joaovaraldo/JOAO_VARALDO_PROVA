...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($usuario) {
        ...
        // SIMULA O ENVIO DO EMAIL ENVIA (GRAVA EM TXT)
        simularEnvioEmail($email, $senha_temporaria);

        echo "<script>alert('Uma senha temporaria foi gerada e enviada. Verifique o arquivo emails_simulados
        .txt'); window.location.href = 'login.php';</script>";
    } else {
