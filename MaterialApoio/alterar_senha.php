...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id_usuario = $_SESSION['usuario_id']; // Corrigido para o nome correto da sessão
    ...
    if ($nova_senha !== $confirmar_senha) {
        ...
        $sql = "UPDATE usuarios SET senha = :senha, senha_temporaria = FALSE WHERE id_usuario = :id";
        $stmt = $pdo->prepare($sql);
        $stmt->bindParam(':senha', $senha); // Corrigido: era $senha_hash (inexistente)
